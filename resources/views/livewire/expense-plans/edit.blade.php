...
new class extends Component
{
    ...
    public function save(): void
    {
        ...
        $this->plan->updateSpentAmount();

        session()->flash('message', 'Plano de despesas atualizado com sucesso!');
...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold">Editar Plano de Despesas</h1>
            <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Atualize as informações do plano</p>
        </div>
