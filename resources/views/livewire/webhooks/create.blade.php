...
new class extends Component
{
    ...
    public function save(): void
    {
        ...
        session()->flash('message', 'Webhook criado com sucesso!');
...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold">Novo Webhook</h1>
            <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Configure um webhook para receber notificações de eventos</p>
        </div>
