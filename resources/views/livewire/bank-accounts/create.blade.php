...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        session()->flash('message', 'Conta bancaria criada com sucesso.');
...
<div class="p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold">Nova Conta Bancaria</h1>
            <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Cadastre uma conta para organizar saldos e transacoes.</p>
        </div>
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 p-6">
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:input wire:model="institution" label="Instituicao" placeholder="Ex: Nubank" />
