        ...
        <flux:sidebar sticky collapsible data-app-sidebar class="sticky top-0 z-50 border-e border-white/5 bg-black/40 backdrop-blur-xl overflow-x-hidden">
            ...
            <flux:sidebar.nav data-app-sidebar-nav class="gap-1 px-2">
                ...
                @if(auth()->user()?->isAdmin())
                    <div x-data="{ open: {{ request()->routeIs('assistant.observability', 'admin.whatsapp-broadcasts.*', 'admin.beta.*', 'admin.email-logs.*', 'admin.commercial-readiness') ? 'true' : 'false' }} }" class="space-y-1">
                        ...
                        <div x-show="open" data-sidebar-group-panel class="space-y-1" x-cloak>
                            ...
                            @can('viewBetaDashboard')
                                ...
                                <flux:sidebar.item icon="envelope" :href="route('admin.email-logs.index')" :current="request()->routeIs('admin.email-logs.*')" wire:navigate>
                                    E-mails
                                </flux:sidebar.item>
                                <flux:sidebar.item icon="shield-check" :href="route('admin.commercial-readiness')" :current="request()->routeIs('admin.commercial-readiness')" wire:navigate>
                                    Comercial
                                </flux:sidebar.item>
                            @endcan
                        </div>
